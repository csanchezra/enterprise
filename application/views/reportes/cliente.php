...
<head>
    ...
    <title>Total de ventas por cliente</title>
          ...
          <table class="table table-striped table-report alert alert-info table-border">
              <thead>
                  <tr style="background-color:#414143">
                      <td style="text-align:center" width="33%" height="28px">
                          <font color="white"><b>CUIT cliente</b></font>
                      </td>
                      <td style="text-align:center" width="33%" height="28px">
                          <font color="white"><b>Producto</b></font>
                      </td>
                      <td style="text-align:center" width="33%" height="28px">
                          <font color="white"><b>Total ventas</b></font>
                      </td>
                      <td style="text-align:center" width="33%" height="28px">
              ...
              <tbody>
                  ...
                  if (!empty($array_datos)) {
                      foreach ($array_datos as $key => $data) {
                          $cuit = $data['CUIT'];
                  ...
                  ?>
                          ...
                          <tr bgcolor="<?= $color ?>">
                              <td style="text-align:center" height="18px">&nbsp;<?= $cuit ?></td>
